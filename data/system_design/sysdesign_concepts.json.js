...
var sysdesign_concepts_ans = [
    {   /* System Design Interviews: A step by step guide */
        id : 1,
        "text" : function(){/*
<p style="text-align: justify;">A lot of software engineers struggle with system design interviews (SDIs) primarily because of three reasons:</p>
<ul>
...
<p style="text-align: justify;">All such questions will determine how our end design will look like.</p>

<h2>Back-of-the-envelope estimation</h2>
<p style="text-align: justify;">It is always a good idea to estimate the scale of the system we&rsquo;re going to design. This will also help later when we will be focusing on scaling, partitioning, load balancing and caching.</p>
<ul>
...
<p style="text-align: justify;">Define what APIs are expected from the system. This will not only establish the exact contract expected from the system but will also ensure if we haven&rsquo;t gotten any requirements wrong. Some examples of APIs for our Twitter-like service will be:</p>
...
<p style="text-align: justify;">Defining the data model in the early part of the interview will clarify how data will flow between different components of the system.
...
<p style="text-align: justify;">Try to discuss as many bottlenecks as possible and different approaches to mitigate them.</p>
<ul>
...
<h2>Summary</h2>
<p style="text-align: justify;">In short, preparation and being organized during the interview are the keys to be successful in system design interviews. The steps mentioned above should guide you to remain on track and cover all the different aspects while designing a system.</p>
<p style="text-align: justify;">Let&rsquo;s apply the above guidelines to design a few systems that are asked in SDIs.</p>
    */}.toString().slice(14,-3)
    },
...
<p style="text-align: justify;">Whenever we are designing a large system, we need to consider a few things:</p>
<ol>
...
<p style="text-align: justify;">Investing in scaling before it is needed is generally not a smart business proposition; however, some forethought into the design can save valuable time and resources in the future. In the following chapters, we will try to define some of the core building blocks of scalable systems. Familiarizing these concepts would greatly benefit in understanding distributed system concepts. In the next section, we will go through Consistent Hashing, CAP Theorem, Load Balancing, Caching, Data Partitioning, Indexes, Proxies, Queues, Replication, and choosing between SQL vs. NoSQL.</p>
<p style="text-align: justify;">Let&rsquo;s start with the Key Characteristics of Distributed Systems.</p>
    */}.toString().slice(14,-3)
    },
...
<h2>Scalability</h2>
<p style="text-align: justify;">Scalability is the capability of a system, process, or a network to grow and manage increased demand. Any distributed system that can continuously evolve in order to support the growing amount of work is considered to be scalable.</p>
<p style="text-align: justify;">A system may have to scale because of many reasons like increased data volume or increased amount of work, e.g., number of transactions. A scalable system would like to achieve this scaling without performance loss.</p>
<p style="text-align: justify;">Generally, the performance of a system, although designed (or claimed) to be scalable, declines with the system size due to the management or environment cost. For instance, network speed may become slower because machines tend to be far apart from one another. More generally, some tasks may not be distributed, either because of their inherent atomic nature or because of some flaw in the system design. At some point, such tasks would limit the speed-up obtained by distribution. A scalable architecture avoids this situation and attempts to balance the load on all the participating nodes evenly.</p>
<p style="text-align: justify;"><strong>Horizontal vs. Vertical Scaling:</strong> Horizontal scaling means that you scale by adding more servers into your pool of resources whereas Vertical scaling means that you scale by adding more power (CPU, RAM, Storage, etc.) to an existing server.</p>
<p style="text-align: justify;">With horizontal-scaling it is often easier to scale dynamically by adding more machines into the existing pool; Vertical-scaling is usually limited to the capacity of a single server and scaling beyond that capacity often involves downtime and comes with an upper limit.</p>
<p style="text-align: justify;">Good examples of horizontal scaling are <a href="https://en.wikipedia.org/wiki/Apache_Cassandra" target="_blank">Cassandra</a> and <a href="https://en.wikipedia.org/wiki/MongoDB" target="_blank">MongoDB</a> as they both provide an easy way to scale horizontally by adding more machines to meet growing needs. Similarly, a good example of vertical scaling is MySQL as it allows for an easy way to scale vertically by switching from smaller to bigger machines. However, this process often involves downtime.</p>
<p style="text-align: center;"><img src="data/system_design/images/sysdesign_concepts/scaling.png" alt="" /></p>

<h2>Reliability</h2>
<p style="text-align: justify;">By definition, reliability is the probability a system will fail in a given period. In simple terms, a distributed system is considered reliable if it keeps delivering its services even when one or several of its software or hardware components fail. Reliability represents one of the main characteristics of any distributed system, since in such systems any failing machine can always be replaced by another healthy one, ensuring the completion of the requested task.</p>
<p style="text-align: justify;">Take the example of a large electronic commerce store (like <a href="https://en.wikipedia.org/wiki/Amazon_(company) target="_blank"">Amazon</a>), where one of the primary requirement is that any user transaction should never be canceled due to a failure of the machine that is running that transaction. For instance, if a user has added an item to their shopping cart, the system is expected not to lose it. A reliable distributed system achieves this through redundancy of both the software components and data. If the server carrying the user&rsquo;s shopping cart fails, another server that has the exact replica of the shopping cart should replace it.</p>
<p style="text-align: justify;">Obviously, redundancy has a cost and a reliable system has to pay that to achieve such resilience for services by eliminating every single point of failure.</p>

<h2>Availability</h2>
<p style="text-align: justify;">By definition, availability is the time a system remains operational to perform its required function in a specific period. It is a simple measure of the percentage of time that a system, service, or a machine remains operational under normal conditions. An aircraft that can be flown for many hours a month without much downtime can be said to have a high availability. Availability takes into account maintainability, repair time, spares availability, and other logistics considerations. If an aircraft is down for maintenance, it is considered not available during that time.</p>
<p style="text-align: justify;">Reliability is availability over time considering the full range of possible real-world conditions that can occur. An aircraft that can make it through any possible weather safely is more reliable than one that has vulnerabilities to possible conditions.</p>
<p style="text-align: justify;"><strong>Reliability Vs. Availability</strong><br />If a system is reliable, it is available. However, if it is available, it is not necessarily reliable. In other words, high reliability contributes to high availability, but it is possible to achieve a high availability even with an unreliable product by minimizing repair time and ensuring that spares are always available when they are needed. Let&rsquo;s take the example of an online retail store that has 99.99% availability for the first two years after its launch. However, the system was launched without any information security testing. The customers are happy with the system, but they don&rsquo;t realize that it isn&rsquo;t very reliable as it is vulnerable to likely risks. In the third year, the system experiences a series of information security incidents that suddenly result in extremely low availability for extended periods of time. This results in reputational and financial damage to the customers.</p>
...
<p style="text-align: justify;">Early detection of faults can decrease or avoid system downtime. For example, some enterprise systems can automatically call a service center (without human intervention) when the system experiences a system fault.</p>
    ...
    */}.toString().slice(14,-3)
    ...
    {   /* Load Balancing */
        id : 4,
        "text" : function(){/*
<p style="text-align: justify;">Load Balancer (LB) is another critical component of any distributed system. It helps to spread the traffic across a cluster of servers to improve responsiveness and availability of applications, websites or databases. LB also keeps track of the status of all the resources while distributing requests. If a server is not available to take new requests or is not responding or has elevated error rate, LB will stop sending traffic to such a server.</p>
<p style="text-align: justify;">Typically a load balancer sits between the client and the server accepting incoming network and application traffic and distributing the traffic across multiple backend servers using various algorithms. By balancing application requests across multiple servers, a load balancer reduces individual server load and prevents any one application server from becoming a single point of failure, thus improving overall application availability and responsiveness.</p>
<p style="text-align: center;"><img src="data/system_design/images/sysdesign_concepts/load_balancer.png" alt="" width="50%" /></p>
<p style="text-align: justify;">To utilize full scalability and redundancy, we can try to balance the load at each layer of the system. We can add LBs at three places:</p>
<ul>
...
<p style="text-align: center;"><img src="data/system_design/images/sysdesign_concepts/load_balancing.png" alt="" width="50%" /></p>

<h2>Client-side load balancing (using service discovery design pattern)</h2>
<p style="text-align: justify;">Consider the following deployment architecture:</p>
<p style="text-align: center;"><img src="data/system_design/images/sysdesign_concepts/client_side_lb1.png" alt="" width="50%" /></p>
<p style="text-align: justify;">We can add a <strong>service registry</strong> in our deployment architecture so that all the services (<strong>booking-service</strong>, <strong>payment-service</strong> and <strong>account-service</strong>), that needs to communicate with each other, <i>register</i> each of their instances with the <strong>service registry</strong>.</p>
<p style="text-align: center;"><img src="data/system_design/images/sysdesign_concepts/client_side_lb2.png" alt="" width="50%" /></p>
<p style="text-align: justify;">Client-side load balancers are <strong>software load balancers</strong> and are used when the client directly chooses which service instance to hit. In this example, <strong>booking-service</strong> retrieves all the information from the <strong>service registry</strong>, and chooses one of the instance and sends the request. Here, the <strong>booking-service</strong> acts as a client and it chooses which particular service instance to hit directly.</p>
<p style="text-align: justify;"><strong>Ribbon</strong> is a framework that enables client-side load balancing.</p>
...
<p style="text-align: justify;">In server-side load balancing, the load balancer can either be a software load balancer (embedded in the service registry) or, a dedicated hardware load balancer as a separate machine.</p>
<table style="border-collapse: collapse; width: 100%;" border="1">
<tbody>
<tr>
<td style="width: 50%;"><p style="text-align: center;"><img src="data/system_design/images/sysdesign_concepts/server_side_lb1.png" alt="" width="100%" /></p></td>
<td style="width: 50%;"><p style="text-align: center;"><img src="data/system_design/images/sysdesign_concepts/server_side_lb2.png" alt="" width="100%" /></p></td>
</tr>
</tbody>
</table>
...
<p style="text-align: justify;"><strong>How does the load balancer choose the backend server?</strong><br />Load balancers consider two factors before forwarding a request to a backend server. They will first ensure that the server they choose is actually responding appropriately to requests and then use a pre-configured algorithm to select one from the set of healthy servers. We will discuss these algorithms shortly.</p>
<p style="text-align: justify;"><strong>Health Checks</strong> - Load balancers should only forward traffic to &ldquo;healthy&rdquo; backend servers. To monitor the health of a backend server, &ldquo;health checks&rdquo; regularly attempt to connect to backend servers to ensure that servers are listening. If a server fails a health check, it is automatically removed from the pool, and traffic will not be forwarded to it until it responds to the health checks again.</p>
<p style="text-align: justify;">There is a variety of load balancing methods, which use different algorithms for different needs.</p>
<ul>
...
<p style="text-align: justify;">The load balancer can be a single point of failure; to overcome this, a second load balancer can be connected to the first to form a cluster. Each LB monitors the health of the other and, since both of them are equally capable of serving traffic and failure detection, in the event the main load balancer fails, the second load balancer takes over.</p>
<p style="text-align: center;"><img src="data/system_design/images/sysdesign_concepts/redundant_load_balancers.png" alt="" width="50%" /></p>

<p style="text-align: justify;">Following links have some good discussion about load balancers:</p>
<ol>
...
<p style="text-align: justify;">Following links have some good discussion about caching:</p>
<ol>
...
<p style="text-align: center;"><img src="data/system_design/images/sysdesign_concepts/library_catalog.png" alt="" width="80%" /></p>
...
<p style="text-align: center;"><img src="data/system_design/images/sysdesign_concepts/proxy_server.png" alt="" width="50%" /></p>
...
<p style="text-align: center;"><img src="data/system_design/images/sysdesign_concepts/data_replication.png" alt="" width="50%" /></p>
<h2>Replication</h2>
...
<p style="text-align: center;"><img src="data/system_design/images/sysdesign_concepts/cap_theorem.png" alt="" width="50%" /></p>
...
<p style="text-align: center;"><img src="data/system_design/images/sysdesign_concepts/consistent_hashing1.png" alt="" width="80%" /></p>
<p style="text-align: center;"><img src="data/system_design/images/sysdesign_concepts/consistent_hashing2.png" alt="" width="80%" /></p>
<p style="text-align: center;"><img src="data/system_design/images/sysdesign_concepts/consistent_hashing3.png" alt="" width="80%" /></p>
<p style="text-align: center;"><img src="data/system_design/images/sysdesign_concepts/consistent_hashing4.png" alt="" width="80%" /></p>
<p style="text-align: center;"><img src="data/system_design/images/sysdesign_concepts/consistent_hashing5.png" alt="" width="80%" /></p>
...
<p style="text-align: center;"><img src="data/system_design/images/sysdesign_concepts/http_protocol.png" alt="" width="80%" /></p>
...
<p style="text-align: center;"><img src="data/system_design/images/sysdesign_concepts/ajax_polling.png" alt="" width="80%" /></p>
...
<p style="text-align: center;"><img src="data/system_design/images/sysdesign_concepts/http_long_polling.png" alt="" width="80%" /></p>
...
<p style="text-align: center;"><img src="data/system_design/images/sysdesign_concepts/web_sockets.png" alt="" width="80%" /></p>
...
<p style="text-align: center;"><img src="data/system_design/images/sysdesign_concepts/server_sent_events.png" alt="" width="80%" /></p>

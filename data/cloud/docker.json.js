...
<p><img src="data\cloud\images\docker\1.running a simple container.png" alt="" width="100%" /></p>
        */}.toString().slice(14,-3)
    },
...
<p style="text-align: justify;"><img src="data\cloud\images\docker\2.running ubuntu image.png" alt="" width="100%"/></p>
...
<p style="text-align: justify;"><img src="data\cloud\images\docker\3.docker run attached mode.png" alt="" width="100%"/></p>
...
<p style="text-align: justify;"><img src="data\cloud\images\docker\4. docker run detached mode.png" alt="" width="100%"/></p>

<table width="100%">
<tbody>
<tr valign="top">
<td><p style="text-align: justify;"><img src="data\cloud\images\docker\5.run -it.png" /></p></td>
<td>
...
<p style="text-align: justify;"><img src="data\cloud\images\docker\6. docker rm.png" alt="" width="100%"/></p>
...
<p style="text-align: justify;"><img src="data\cloud\images\docker\7. docker rmi.png" alt="" width="100%"/></p>
<p style="text-align: justify;">Using docker exec command:</p>
<p style="text-align: justify;"><img src="data\cloud\images\docker\8. docker exec.png" alt="" width="100%"/></p>
...
<p style="text-align: justify;"><img src="data\cloud\images\docker\9. docker run tag1.png" alt="" width="690" height="289" /></p>
<p style="text-align: justify;"><img src="data\cloud\images\docker\9. docker run tag2.png" alt="" /></p>
        */}.toString().slice(14,-3)
    },
...
<p><img src="data\cloud\images\docker\10. docker run port mapping.png" /></p>
...
<p><img src="data\cloud\images\docker\11. docker run port mapping1.png" width="100%" /></p>
...
<p><img src="data\cloud\images\docker\12. docker run port mapping2.png" width="100%" /></p>
...
<p><img src="data\cloud\images\docker\create image - manually\1.png" /></p>
</li>
<li style="text-align: justify;">
...
<p><img src="data\cloud\images\docker\create image - manually\2.png" width="100%"/></p>
</li>
<li style="text-align: justify;">
...
<p><img src="data\cloud\images\docker\create image - manually\3.png" width="100%"/></p>
</li>
<li style="text-align: justify;">
...
<p><img src="data\cloud\images\docker\create image - manually\4.png" width="100%"/></p>
</li>
<li style="text-align: justify;">
...
<p><img src="data\cloud\images\docker\create image - manually\5.png" width="100%"/></p>
</li>
<li style="text-align: justify;">
...
<p><img src="data\cloud\images\docker\create image - manually\6.png" width="100%"/></p>
</li>
...
<p><img src="data\cloud\images\docker\create image - automatically\1.png" width="100%"/></p>
...
<p><img src="data\cloud\images\docker\create image - automatically\2.png" width="100%"/></p>
<p>References:</p>
...
<p style="text-align: justify;"><img src="data\cloud\images\docker\create image - automatically\3.png" alt="" width="100%" /></p>
...
<p style="text-align: justify;"><img src="data\cloud\images\docker\create image - automatically\4.png" alt="" width="100%" /></p>
        */}.toString().slice(14,-3)
    },
]
...
<p>The authors of <a href="http://wiki.c2.com/?DesignPatternsBook" target="_blank">this</a> book on design patterns are often referred to as the&nbsp;<a href="http://wiki.c2.com/?GangOfFour" target="_blank">Gang of Four</a> (GoF).</p>
<h3>Creational</h3>
<p>These are ones that create objects, rather than having to instantiate objects directly. This gives the program more flexibility in deciding which objects need to be created for a given case.</p>
...
<p>Reference: <a href="https://stackoverflow.com/questions/1673841/examples-of-gof-design-patterns-in-javas-core-libraries" target="_blank">Examples of GoF Design Patterns in Java's core libraries</a></p>
    */}.toString().slice(14,-3)
    },
];